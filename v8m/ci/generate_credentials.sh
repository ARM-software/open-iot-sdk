...
if [[ ! -z "$OTA_ENDPOINT" && ! -z "$OTA_CLIENT_CERT" && ! -z "$OTA_CLIENT_PRIV" && ! -z "$OTA_CLIENT_PUB" ]]; then
    cat >"$OUTPUT_PATH/aws_clientcredential.h" <<EOF
#ifndef __AWS_CLIENTCREDENTIAL__H__
#define __AWS_CLIENTCREDENTIAL__H__
#define clientcredentialMQTT_BROKER_ENDPOINT         "$OTA_ENDPOINT"
#define clientcredentialIOT_THING_NAME               "ota-ci-test-thing-$TEST_ID"
...
#define keyCLIENT_CERTIFICATE_PEM   "$OTA_CLIENT_CERT"
#define keyCLIENT_PRIVATE_KEY_PEM   "$OTA_CLIENT_PRIV"
#define keyJITR_DEVICE_CERTIFICATE_AUTHORITY_PEM  ""
#define keyCLIENT_PUBLIC_KEY_PEM    "$OTA_CLIENT_PUB"
