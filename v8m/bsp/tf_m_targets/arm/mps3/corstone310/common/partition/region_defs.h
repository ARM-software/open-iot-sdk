...
#define NS_HEAP_SIZE            (0x00B0000)
#define NS_STACK_SIZE           (0x0002800)
...
/* Size of vector table: 224 interrupt handlers + 4 bytes MPS initial value */
#define S_CODE_VECTOR_TABLE_SIZE    (964)
