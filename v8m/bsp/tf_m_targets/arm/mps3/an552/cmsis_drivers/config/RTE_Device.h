...
// <e> FLASH (Flash Memory) [Driver_SRAM]
// <i> Configuration settings for Driver_SRAM in component ::Drivers:FLASH
#define   RTE_SRAM                       1

// <e> FLASH (Flash Memory) [Driver_ISRAM1]
// <i> Configuration settings for Driver_ISRAM in component ::Drivers:FLASH
#define   RTE_ISRAM1                     1
