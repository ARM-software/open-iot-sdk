...
void mpc_revert_non_secure_to_secure_cfg(void)
{
    ...
    Driver_DDR4_MPC.ConfigRegion(DDR4_BLK1_BASE_S,
                                 MPC_DDR4_BLK1_RANGE_LIMIT_S,
                                 ARM_MPC_ATTR_SECURE);

    Driver_QSPI_MPC.ConfigRegion(DDR4_BLK3_BASE_S,
                                 MPC_DDR4_BLK3_RANGE_LIMIT_S,
                                 ARM_MPC_ATTR_SECURE);
...
enum tfm_plat_err_t ppc_init_cfg(void)
{
    ...
    err |= Driver_PPC_POLARIS_MAIN_EXP0.ConfigSecurity(
                                        ...
                                        PPC_POLARIS_NONSECURE_CONFIG);
    err |= Driver_PPC_POLARIS_MAIN_EXP0.ConfigSecurity(
                                        USER_AHB0_MAIN_PPCEXP0_POS_MASK,
                                        PPC_POLARIS_NONSECURE_CONFIG);
    err |= Driver_PPC_POLARIS_MAIN_EXP0.ConfigSecurity(
                                        USER_AHB1_MAIN_PPCEXP0_POS_MASK,
                                        PPC_POLARIS_NONSECURE_CONFIG);
    err |= Driver_PPC_POLARIS_MAIN_EXP0.ConfigSecurity(
                                        USER_AHB2_MAIN_PPCEXP0_POS_MASK,
                                        PPC_POLARIS_NONSECURE_CONFIG);
    err |= Driver_PPC_POLARIS_MAIN_EXP0.ConfigSecurity(
                                        USER_AHB3_MAIN_PPCEXP0_POS_MASK,
                                        PPC_POLARIS_NONSECURE_CONFIG);
    ...
    /* Grant non-secure access to peripherals on PERIPH EXP0 */
    err |= Driver_PPC_POLARIS_PERIPH_EXP0.Initialize();

    err |= Driver_PPC_POLARIS_PERIPH_EXP0.ConfigSecurity(
                                        NPU_APB0_PERIPH_PPCEXP0_POS_MASK,
                                        PPC_POLARIS_NONSECURE_CONFIG);
    err |= Driver_PPC_POLARIS_PERIPH_EXP0.ConfigSecurity(
                                        NPU_APB1_PERIPH_PPCEXP0_POS_MASK,
                                        PPC_POLARIS_NONSECURE_CONFIG);

    err |= Driver_PPC_POLARIS_PERIPH_EXP0.ConfigSecurity(
                                        USER_MEM_APB0_PERIPH_PPCEXP0_POS_MASK,
                                        PPC_POLARIS_NONSECURE_CONFIG);
    err |= Driver_PPC_POLARIS_PERIPH_EXP0.ConfigSecurity(
                                        USER_MEM_APB1_PERIPH_PPCEXP0_POS_MASK,
                                        PPC_POLARIS_NONSECURE_CONFIG);
